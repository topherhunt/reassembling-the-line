defmodule RTLWeb.Manage.ProjectSettingControllerTest do
  ...
  describe "plugs" do
    test "rejects if not superadmin", %{conn: conn} do
      ...
      conn = get(conn, Routes.manage_project_setting_path(conn, :edit, p, "show_explore_link"))
  ...
  describe "#edit" do
    test "renders correctly", %{conn: conn} do
      ...
      assert conn.resp_body =~ "show_explore_link"
    end
  end
  ...
  describe "#update" do
    test "saves the setting and redirects", %{conn: conn} do
      ...
      assert Projects.get_project!(project.id).settings["show_explore_link"] == "new value"
  ...
  defp edit_path(conn, project) do
    Routes.manage_project_setting_path(conn, :edit, project, "show_explore_link")
  end

  defp update_path(conn, project) do
    Routes.manage_project_setting_path(conn, :update, project, "show_explore_link")
  end
end
