defmodule RTLWeb.ResultsControllerTest do
  ...
  describe "#index" do
    test "renders the page (no login needed)", %{conn: conn} do
      ...
      conn = get(conn, Routes.results_path(conn, :index, project))
  ...
  describe "#playlist" do
    test "returns a JSON playlist for this search", %{conn: conn} do
      ...
      conn = get(conn, Routes.results_path(conn, :playlist, project), tags: "abc,ghi")
